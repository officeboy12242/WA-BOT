...
export function buildResumeTailorSystemPrompt(mode = 'related') {
    ...
    const sharedRules = [
        ...
        '- If BASE is ATS: keep "Role | skills" headline, "phone | email | links", "Title | Company<TAB>dates", year bands, "Project | stack | url", and the same bullet character.',
        '- If BASE is classic: "Job Title<TAB>dates" then company line, then bullets — mirror BASE punctuation.',
        '',
